...
export const DashboardHeader = ({ searchQuery, onSearchChange, onRefresh }: DashboardHeaderProps) => {
  ...
  return (
    <header className="bg-dashboard-header border-b border-border sticky top-0 z-10">
      <div className="px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            {searchQuery !== undefined && onSearchChange && location.pathname !== '/dshub/organizations' && (
            ...
            {onRefresh && location.pathname !== '/dshub/organizations' && (
              <Button
                variant="outline"
                size="sm"
                onClick={onRefresh}
